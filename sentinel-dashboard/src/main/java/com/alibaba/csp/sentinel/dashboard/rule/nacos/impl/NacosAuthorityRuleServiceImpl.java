 ...
 * 授权规则
 */
@Component(NacosConstants.strategy + RuleConstants.AUTHORITY_RULE_SERVICE)
public class NacosAuthorityRuleServiceImpl extends NacosRuleAbstract<AuthorityRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getAuthorityRule());
    }
}