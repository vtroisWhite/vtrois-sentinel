 ...
 * 系统规则
 */
@Component(NacosConstants.strategy + RuleConstants.SYSTEM_RULE_SERVICE)
public class NacosSystemRuleServiceImpl extends NacosRuleAbstract<SystemRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getSystemRule());
    }
}