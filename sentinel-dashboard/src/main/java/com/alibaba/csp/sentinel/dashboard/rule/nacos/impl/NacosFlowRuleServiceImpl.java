 ...
 * @since 1.4.0
 */
@Component(NacosConstants.strategy + RuleConstants.FLOW_RULE_SERVICE)
public class NacosFlowRuleServiceImpl extends NacosRuleAbstract<FlowRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getFlowRule());
    }
}
