 ...
 * push熔断降级规则
 */
@Component(ZookeeperConstants.strategy + RuleConstants.GATEWAY_FLOW_RULE_SERVICE)
public class ZookeeperGatewayFlowServiceImpl extends ZookeeperRuleAbstract<DegradeRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getGatewayFlowRule());
    }
}