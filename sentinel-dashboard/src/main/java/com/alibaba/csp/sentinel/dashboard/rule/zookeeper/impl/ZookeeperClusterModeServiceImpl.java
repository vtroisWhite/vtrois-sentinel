 ...
 * 集群配置
 */
@Component(ZookeeperConstants.strategy + RuleConstants.CLUSTER_MODE_SERVICE)
public class ZookeeperClusterModeServiceImpl extends ZookeeperRuleAbstract<SentinelClusterConfigEntity.Mode> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getClusterModeRule());
    }
}