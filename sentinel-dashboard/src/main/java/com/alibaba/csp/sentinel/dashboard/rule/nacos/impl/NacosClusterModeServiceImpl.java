 ...
 * 集群规则
 */
@Component(NacosConstants.strategy + RuleConstants.CLUSTER_MODE_SERVICE)
public class NacosClusterModeServiceImpl extends NacosRuleAbstract<SentinelClusterConfigEntity.Mode> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getClusterModeRule());
    }
}