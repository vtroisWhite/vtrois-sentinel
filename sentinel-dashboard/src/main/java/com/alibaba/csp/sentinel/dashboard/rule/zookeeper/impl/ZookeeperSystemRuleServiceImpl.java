 ...
 * push熔断降级规则
 */
@Component(ZookeeperConstants.strategy + RuleConstants.SYSTEM_RULE_SERVICE)
public class ZookeeperSystemRuleServiceImpl extends ZookeeperRuleAbstract<DegradeRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getSystemRule());
    }
}