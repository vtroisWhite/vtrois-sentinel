 ...
 * push熔断降级规则
 */
@Component(ZookeeperConstants.strategy + RuleConstants.GATEWAY_API_FLOW_RULE_SERVICE)
public class ZookeeperGatewayApiRuleServiceImpl extends ZookeeperRuleAbstract<DegradeRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getGatewayApiFlowRule());
    }
}