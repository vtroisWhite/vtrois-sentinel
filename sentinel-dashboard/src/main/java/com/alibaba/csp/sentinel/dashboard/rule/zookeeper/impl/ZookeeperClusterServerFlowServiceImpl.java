 ...
 * 集群配置
 */
@Component(ZookeeperConstants.strategy + RuleConstants.CLUSTER_SERVER_FLOW_SERVICE)
public class ZookeeperClusterServerFlowServiceImpl extends ZookeeperRuleAbstract<SentinelClusterConfigEntity.ServerFlow> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getClusterServerFlowRule());
    }
}