 ...
 * 集群规则
 */
@Component(NacosConstants.strategy + RuleConstants.CLUSTER_SERVER_NAMESPACE_SERVICE)
public class NacosClusterServerNamespaceServiceImpl extends NacosRuleAbstract<SentinelClusterConfigEntity.ServerNamespace> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getClusterServerNamespaceRule());
    }
}