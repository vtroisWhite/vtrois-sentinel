 ...
 * 集群规则
 */
@Component(NacosConstants.strategy + RuleConstants.CLUSTER_SERVER_TRANSPORT_SERVICE)
public class NacosClusterServerTransportServiceImpl extends NacosRuleAbstract<SentinelClusterConfigEntity.ServerTransport> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getClusterServerTransportRule());
    }
}