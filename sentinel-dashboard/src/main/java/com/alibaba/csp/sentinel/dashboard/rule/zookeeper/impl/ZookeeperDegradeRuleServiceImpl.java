 ...
 * push熔断降级规则
 */
@Component(ZookeeperConstants.strategy + RuleConstants.DEGRADE_RULE_SERVICE)
public class ZookeeperDegradeRuleServiceImpl extends ZookeeperRuleAbstract<DegradeRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getDegradeRule());
    }
}