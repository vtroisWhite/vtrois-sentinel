 ...
 * 集群配置
 */
@Component(ZookeeperConstants.strategy + RuleConstants.CLUSTER_CLIENT_CONFIG_SERVICE)
public class ZookeeperClusterClientConfigServiceImpl extends ZookeeperRuleAbstract<SentinelClusterConfigEntity.ClientConfig> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getClusterClientConfigRule());
    }
}