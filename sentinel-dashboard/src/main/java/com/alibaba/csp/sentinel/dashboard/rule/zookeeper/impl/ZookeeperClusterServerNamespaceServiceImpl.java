 ...
 * 集群配置
 */
@Component(ZookeeperConstants.strategy + RuleConstants.CLUSTER_SERVER_TRANSPORT_SERVICE)
public class ZookeeperClusterServerNamespaceServiceImpl extends ZookeeperRuleAbstract<SentinelClusterConfigEntity.ServerNamespace> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getClusterServerNamespaceRule());
    }
}