 ...
 * 网关api限流
 */
@Component(NacosConstants.strategy + RuleConstants.GATEWAY_API_FLOW_RULE_SERVICE)
public class NacosGatewayApiRulesServiceImpl extends NacosRuleAbstract<ApiDefinitionEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getGatewayApiFlowRule());
    }
}