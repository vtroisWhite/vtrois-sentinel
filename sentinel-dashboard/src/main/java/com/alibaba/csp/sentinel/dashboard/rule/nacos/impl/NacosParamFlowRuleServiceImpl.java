 ...
 * 热点规则
 */
@Component(NacosConstants.strategy + RuleConstants.PARAM_RULE_SERVICE)
public class NacosParamFlowRuleServiceImpl extends NacosRuleAbstract<ParamFlowRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getParamFlowRule());
    }
}