 ...
 * 集群规则
 */
@Component(NacosConstants.strategy + RuleConstants.CLUSTER_CLIENT_CONFIG_SERVICE)
public class NacosClusterClientConfigServiceImpl extends NacosRuleAbstract<SentinelClusterConfigEntity.ClientConfig> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getClusterClientConfigRule());
    }
}