 ...
 * 集群配置
 */
@Component(ZookeeperConstants.strategy + RuleConstants.CLUSTER_SERVER_NAMESPACE_SERVICE)
public class ZookeeperClusterServerTransportServiceImpl extends ZookeeperRuleAbstract<SentinelClusterConfigEntity.ServerTransport> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getClusterServerTransportRule());
    }
}