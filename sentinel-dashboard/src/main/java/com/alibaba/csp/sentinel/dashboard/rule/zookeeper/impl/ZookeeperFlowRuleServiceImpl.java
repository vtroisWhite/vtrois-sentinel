 ...
 * 读取限流规则
 */
@Component(ZookeeperConstants.strategy + RuleConstants.FLOW_RULE_SERVICE)
public class ZookeeperFlowRuleServiceImpl extends ZookeeperRuleAbstract<FlowRuleEntity> {
    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getFlowRule());
    }
