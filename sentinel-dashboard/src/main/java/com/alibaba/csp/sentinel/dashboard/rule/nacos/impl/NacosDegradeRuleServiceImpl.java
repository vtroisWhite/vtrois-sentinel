 ...
 * push熔断降级规则
 */
@Component(NacosConstants.strategy + RuleConstants.DEGRADE_RULE_SERVICE)
public class NacosDegradeRuleServiceImpl extends NacosRuleAbstract<DegradeRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return NacosConfig.geDefRulePath(param, rulePath.getDegradeRule());
    }
}