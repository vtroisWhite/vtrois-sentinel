 ...
 * push熔断降级规则
 */
@Component(ZookeeperConstants.strategy + RuleConstants.AUTHORITY_RULE_SERVICE)
public class ZookeeperAuthorityRuleServiceImpl extends ZookeeperRuleAbstract<DegradeRuleEntity> {

    @Override
    public String getRulePath(RuleParam param) {
        return ZookeeperConfig.geDefRulePath(param, rulePath.getAuthorityRule());
    }
}